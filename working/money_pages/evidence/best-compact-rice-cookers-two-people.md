# Best Compact Rice Cookers for Two People - Evidence Brief

## Target

- Target URL: `/best/compact-rice-cookers-two-people/`
- Primary keyword: `best compact rice cooker for two people`
- Buyer problem: Cook reliable small rice batches with easy cleanup.
- Evidence needed: cooked/uncooked capacity, pot cleaning, lid clearance, keep-warm behavior, cord storage.
...
- [x] Collect 6-8 compact rice cooker candidates.
- [x] Record whether capacity is cooked or uncooked.
- [x] Record minimum practical batch size if source gives it.
- [x] Record lid opening/clearance and steam vent direction where source data is available.
- [x] Record pot material/coating and cleaning notes.
...
| Candidate | Capacity | Footprint / fit evidence | Cleaning / lid evidence | Evidence status |
| --- | --- | --- | --- | --- |
...
- Zojirushi NS-LGC05 product page: `https://www.zojirushi.com/app/product/nslgc`
- Zojirushi NS-LGC05 manual: `https://www.zojirushi.com/servicesupport/manuals/manual_pdf/ns_lgc05_e.pdf`
- Zojirushi NHS-06 product page: `https://www.zojirushi.com/app/product/nhs`
- Zojirushi NHS-06 manual: `https://www.zojirushi.com/servicesupport/manuals/manual_pdf/nhs.pdf`
...
- Tiger dimensions source: `https://www.walmart.com/ip/Tiger-JAJ-A55U-PP-3-Cup-Uncooked-Micom-Rice-Cooker-with-Slow-Cooker-Bread-Maker-Pink/143783100`

## Draft Positioning Notes

- Do not call these recommendations yet. They are candidates only.
- First-pass finalist set: Zojirushi NS-LGC05, Zojirushi NHS-06, Dash Mini, GreenLife Go Grains, Aroma ARC-914SBD.
- Cuckoo CR-0375F is useful as a compact micom alternative, but weight and counter depth need careful framing.
- Hold Tiger JAJ-A55U until current US availability and model status are confirmed.
