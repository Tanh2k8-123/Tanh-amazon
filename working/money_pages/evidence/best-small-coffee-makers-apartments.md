# Best Small Coffee Makers for Apartments - Evidence Brief

## Target

- Target URL: `/best/small-coffee-makers-apartments/`
- Primary keyword: `best small coffee maker for apartment`
- Buyer problem: Make coffee in a small space without a messy setup.
- Evidence needed: brew type, footprint, water tank access, cleaning parts, noise, mug clearance.
...
- [x] Collect 6-8 small coffee maker candidates across drip, single-serve, manual, capsule, and compact espresso styles.
- [x] Record footprint, height, and cabinet clearance where official/source data is available.
- [x] Record water access and tank cleaning friction.
- [x] Record brew volume and mug clearance where relevant.
- [x] Record reusable/disposable filter requirements.
...
- Mr. Coffee 5-Cup Programmable Mini Brew: `https://www.mrcoffee.com/coffee-makers/5-cup-coffee-makers/mr.-coffee-5-cup-programmable-coffee-maker-25-oz.-mini-brew-brew-now-or-later-with-water-filtration-and-nylon/SP_304248.html`
- Keurig K-Mini product page: `https://www.keurig.com/Home-Coffee-Makers/K-Mini%C2%AE-Single-Serve-Coffee-Maker/p/K-Mini-Coffee-Maker`
- Keurig K-Mini support article: `https://support.keurig.com/?kmContentId=1014709&page=shell&shell=knowledge-article`
- Keurig K-Mini Basic User Guide: `https://dam.keurig.com/content/dam/public-assets/support/kcom/pdf/KMini_UCG.pdf`
- Nespresso Essenza Mini C30 product page: `https://www.nespresso.com/us/en/order/machines/original/essenza-mini-c30-intense-grey`
- Nespresso Essenza Mini manual: `https://www.nespresso.com/shared_res/manuals/essenza-mini/2018/UM_ESSENZA_MINI_EN_FNL.pdf`
- Hamilton Beach The Scoop product page: `https://hamiltonbeach.com/the-scoop-single-serve-coffee-maker-49981`
- Hamilton Beach The Scoop manual: `https://useandcares.hamiltonbeach.com/files/840231200.pdf`
- AeroPress Original product page: `https://aeropress.com/products/aeropress-coffee-maker`
- Breville Bambino product page: `https://www.breville.com/en-us/product/bes450`
...
- 2026-06-24: Expanded Keurig product details confirmed a 6-12 oz brew range, one-cup reservoir, rear cord storage, official dimensions, open-handle height, and product weight. The compact highlight graphic still showed inconsistent shorthand, so the expanded details and model-specific guide are the controlling evidence.
- 2026-06-24: Keurig Support search located article `1014709`, published 2024-11-14, which links the official K-Mini Basic User Guide. Pages 3-5 document reservoir/drip-tray care, removable pod-holder/funnel cleaning, entrance/exit needle care, two water-only rinse cycles, and descaling every three months.
